  ...
  const sampleResults: SearchResult[] = [
    {
      ...
      content: 'JWT authentication middleware for protecting API routes. Includes token validation, user extraction, and error handling...',
      type: 'code',
      source: 'auth.py',
      project: 'NeuroSync Backend',
      timestamp: '2024-01-15T10:30:00Z',
      relevance_score: 0.95,
      url: '/projects/backend/auth.py'
    },
    {
      id: '2',
      title: 'API Documentation - Authentication',
      content: 'Complete guide for implementing authentication in the NeuroSync API. Covers JWT tokens, refresh mechanisms...',
      type: 'document',
      source: 'API_DOCS.md',
      project: 'NeuroSync Docs',
    ...
    {
      id: '3',
      title: 'Discussion: Auth token expiration',
      content: 'Team discussion about JWT token expiration times and refresh token strategy. Sarah suggested 15min access tokens...',
      type: 'chat',
      source: 'Slack #backend',
      project: 'NeuroSync Backend',
    ...
    {
      id: '4',
      title: 'Sprint Planning - Auth Features',
      content: 'Meeting notes covering authentication feature planning. Discussed OAuth integration, password reset flow...',
      type: 'meeting',
